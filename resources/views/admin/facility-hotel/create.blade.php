...
<div class="header">
    <h5>{{ isset($facilityHotel) ? 'Edit Fasilitas Hotel' : 'Tambah Fasilitas Hotel' }}</h5>
...
<div class="form-container">
    <form action="{{ isset($facilityHotel) ? route('facility-hotels.update', $facilityHotel->id) : route('facility-hotels.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        @if (isset($facilityHotel))
            @method('PUT')
        @endif
        ...
        @if (isset($facilityHotel) && $facilityHotel->image)
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">
                ...
                {{ isset($facilityHotel) ? 'Update' : 'Tambah' }} Fasilitas
            </button>
            <a href="{{ route('facility-hotels.index') }}" class="btn btn-secondary">
